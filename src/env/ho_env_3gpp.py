...
def print_statistics(ho_3gpp_: HandoverEnv3GPP, sinr_db_mat: np.ndarray) -> None:
    ...
    values = [
        ...
        f"{len(ho_3gpp_.cntr['rlfr'].start_idxs)/len(ho_3gpp_.cntr['ho_exec'].start_idxs)*100:.3f}%",
        f"{len(ho_3gpp_.cntr['mtsc'].aborted_idxs)}",
        f"{len(ho_3gpp_.cntr['mtsc'].aborted_idxs)/len(ho_3gpp_.cntr['ho_exec'].start_idxs)*100:.3f}%",
    ]
